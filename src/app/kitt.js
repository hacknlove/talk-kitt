const knightSong = 'https://manzdev.github.io/starworkshop-jsday/knight.7088a6bd.mp3';
...
const Kitt = class {
  ...
  stopTalk() {
    this.audio.stop();
    clearInterval(this.talkingId);
    this.talkingId = null;
    this.renderKitt(-1);
    Array.from(document.querySelectorAll('.low-panel .big-btn'))
